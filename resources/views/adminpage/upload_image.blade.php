...
@section('content')
    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <!-- Upload Form -->
            <div class="bg-white dark:bg-gray-900 mt-4 rounded-lg shadow p-6">
                <h3 class="text-xl font-semibold text-primary-600 dark:text-primary-500 mb-4">Upload Image</h3>
                <form action="{{ url('/home/update_image/' . $key) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="mb-4">
                        <label for="image" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Upload
                            Picture:</label>
            ...
            <div class="bg-white dark:bg-gray-900 mt-4 rounded-lg shadow p-6">
                <h3 class="text-xl font-semibold text-primary-600 dark:text-primary-500 mb-4">Uploaded Image</h3>
                <img id="uploadedImage" src="{{ $editdata['image'] }}" alt="Uploaded Image"
