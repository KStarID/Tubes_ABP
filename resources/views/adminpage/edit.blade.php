        ...
        <div class="container mx-auto px-4 py-6">
            <div class="bg-white dark:bg-gray-900 rounded-lg shadow p-6">
                <div class="border-b border-gray-200 pb-4 mb-4">
                    <h4
                        class="text-2xl mx-3 font-semibold text-gray-800 dark:text-gray-100 flex justify-between items-center">
                        Edit Cars
                        <a href="{{ route('cars') }}"
                            ...
                            <div class="mb-4">
                                ...
                                <select name="bahan_bakar"
                                    ...
                                    <option value="Solar (Diesel)"
                                        {{ $editdata['bahan_bakar'] === 'Solar (Diesel)' ? 'selected' : '' }}>Solar
                                        (Diesel)
                                    </option>
                                    <option value="Gas alam (CNG)"
                                        {{ $editdata['bahan_bakar'] === 'Gas alam (CNG)' ? 'selected' : '' }}>Gas alam
                                        (CNG)
                                    </option>
                                    <option value="Listrik (Electricity)"
                                        {{ $editdata['bahan_bakar'] === 'Listrik (Electricity)' ? 'selected' : '' }}>
                                        Listrik
                                        (Electricity)</option>
                                </select>
                            </div>
                        ...
                        <div>
                            <div class="mb-4">
                                ...
                                <select name="transmisi"
                                    ...
                                    <option value="Manual" {{ $editdata['transmisi'] === 'Manual' ? 'selected' : '' }}>
                                        Manual
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="mb-4">
                                <label class="block mb-1 font-medium text-gray-900 dark:text-white">Deskripsi
                                    Tambahan</label>
                            ...
                            <div class="mb-4">
                                <label class="block mb-1 font-medium text-gray-900 dark:text-white">Kontak Penjual
                                    (WA)</label>
