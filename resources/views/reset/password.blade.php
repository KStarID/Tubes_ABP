            ...
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    {!! Form::open([
                        ...
                        'method' => 'POST',
                        'action' => 'App\Http\Controllers\Auth\ResetController@store',
                    ]) !!}

                    <div class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        {!! Form::label('email', 'Email:', ['class' => 'block mb-2 text-sm font-medium text-gray-900 dark:text-white']) !!}
                    ...
                    {!! Form::submit('Sent Email', [
                        'class' =>
                            'cursor-pointer w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800',
                    ]) !!}
